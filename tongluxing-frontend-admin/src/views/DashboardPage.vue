...
const metrics = computed(() => [
  ...
  ['认证驾驶员', number(data.value.certifiedDriverCount), `异常待处理 ${number(data.value.pendingDrivingLicenseCount)}`, BadgeCheck],
