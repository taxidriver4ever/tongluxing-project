...
ALTER TABLE map_route_plan MODIFY COLUMN provider_type VARCHAR(32) NOT NULL;
...
ALTER TABLE map_location_search_log MODIFY COLUMN provider_type VARCHAR(32) NOT NULL;
...
ALTER TABLE map_geocode_cache MODIFY COLUMN provider_type VARCHAR(32) NOT NULL;
