...
CREATE TABLE IF NOT EXISTS team_member (
  ...
  active_user_key BIGINT GENERATED ALWAYS AS (CASE WHEN deleted = 0 AND member_status = 'ACTIVE' THEN user_id ELSE NULL END) STORED,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  deleted TINYINT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (id),
  UNIQUE KEY uk_team_member_user (team_id, user_id, deleted),
  UNIQUE KEY uk_team_member_active_user (active_user_key),
